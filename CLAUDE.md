...
Never include generated by claude code in git summary
Always git commit and push if done

always right tests and always test

Rather create a component than to do the same task 100x. for example a Button should exist and should get more functionality so every button bbenefits
