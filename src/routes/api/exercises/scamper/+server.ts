...
- suggestions: 3-5 creative ideas the user did NOT think of, to inspire them. Mix across different lenses.

Respond in JSON only: {"originality": number, "practicality": number, "lensAgility": number, "lensHighlights": {"substitute": "...", ...}, "feedback": "...", "suggestions": ["idea1", ...]}`
			},
			{
				role: 'user',
